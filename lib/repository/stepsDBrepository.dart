...
class DatabaseRepository extends ChangeNotifier {
  ...
  DateTime nowMidnight = DateTime(
      DateTime.now().year, DateTime.now().month, DateTime.now().day, 0, 0, 0);
  DateTime nowBM = DateTime(DateTime.now().year, DateTime.now().month,
      DateTime.now().day, 23, 59, 59);
  String startDate = DateTime(DateTime.now().year, DateTime.now().month,
